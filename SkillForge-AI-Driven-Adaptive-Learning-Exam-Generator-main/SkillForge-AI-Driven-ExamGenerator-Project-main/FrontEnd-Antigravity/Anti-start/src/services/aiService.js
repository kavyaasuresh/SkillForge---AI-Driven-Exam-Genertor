...
export const aiService = {
    async generateQuestions(params) {
        ...
        try {
            ...
            console.log('🔄 AI Service - Transformed questions:', transformedQuestions);
            ...
            if (!hasRealQuestions) {
                console.warn('⚠️ Received sample questions instead of AI-generated content');
            }
    ...
    async saveAiQuiz(quizData) {
        console.log('💾 AI Service - Saving quiz:', quizData);
        try {
            const response = await axios.post(
            ...
            console.log('✅ AI Service - Quiz saved successfully:', response.data);
            return response.data;
        } catch (error) {
            console.error('❌ AI Service - Save failed:', error);
    ...
    async generateStudySuggestions(params) {
        try {
            ...
            console.error('❌ AI Service - Study suggestions failed:', error);
